...
//  TODO: Your dataset filename. Expected format is CSV
  private static final String FILENAME = "src/opt/test/pendigits.csv";
  ...
  private static int numberHiddenLayerNodes = 200;

/*
  ===========Cross Validation for NN Params=========
  Nodes: 21       Error: 11.557%
  Nodes: 5        Error: 49.235%
  Nodes: 10       Error: 19.983%
  Nodes: 20       Error: 12.961%
  Nodes: 50       Error: 5.270%
  Nodes: 100      Error: 3.735%
  Nodes: 200      Error: 2.564%

  Best Num Hidden Nodes: 200      Error: 2.564%
*/
...
/*  ===========Determining Simulated Annealing Params=========
  Best Cooling: 0.900
  Best Temp: 100000000.000
*/
    ...
    for (int x = 0; x < populationRatios.length; x++) {
      ...
      for (int y = 0; y < mateRatios.length; y++) {
        ...
        for (int z = 0; z < mutateRatios.length; z++) {
          ...
          System.out.format("Population %f, Mate %f, Mutate %f\n", populationRatios[x], mateRatios[y], mutateRatios[z]);
